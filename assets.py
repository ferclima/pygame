...
def load_assets():
    ...
    paisagem_5 = pygame.image.load('Imagens\The END2.png').convert_alpha()
    paisagem_5 = pygame.transform.scale(paisagem_5, (WIDTH, HEIGHT)) 
    assets['paisagem'] = [paisagem_1, paisagem_2, paisagem_3, paisagem_4, paisagem_5]
